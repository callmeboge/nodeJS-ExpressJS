...
const person = [
    { id: 1, name: "Aaron", job: "Terminator"},
    { id: 2, name: "John", job: "Terminator"},
    { id: 3, name: "Noah", job: "Terminator"},
    { id: 4, name: "Abraham", job: "Terminator"},
    { id: 5, name: "Moses", job: "Terminator"},
    { id: 6, name: "Maria", job: "Terminator"},
];
